...
namespace GNB
{
    ...
    public class Gun : MonoBehaviour
    {
        ...
        public ProjectileDataCodex projectileDataCodex = null;
        ...
        {
            var bullet = BulletPool.Instance.GetBullet(BulletPrefab, firePoint.transform.position, firePoint.transform.rotation, null);
